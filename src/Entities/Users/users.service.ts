...
export class UserService extends CrudService<CreateUserDto, UserDto, UserDocument, UsersRepoService>{
    ...
    public async TakeByLoginAndEmail(sortBy: keyof (UserDto), sortDirection: "asc" | "desc", loginValue?: string, emailValue?: string, skip: number = 0, limit: number = 10)
        ...
        let findPattern = new MongooseRepoFindPattern(loginFindUnit, emailFindUnit);
